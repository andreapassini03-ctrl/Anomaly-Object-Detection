...
# Utilizza solo le immagini "good" per addestramento
...
if X_train_normal.size == 0:
    ...
    # Modello con più livelli e Dropout per evitare overfitting
    ...
    history = autoencoder.fit(X_train_normal, X_train_normal,
                            epochs=100, # 100 epoche perchè 50 risultavano poche
                            batch_size=16, # batch size bassa per un addestramento più "fine"
                            shuffle=True,
